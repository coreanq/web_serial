export const en = {
  ...
  connection: {
    ...
    status: {
      ...
      tcpNativeConnected: "TCP Native Connected",
      tcpNativeConnecting: "Connecting to TCP Device...",
      tcpNativeFailed: "TCP Native Connection Failed",
      tcpNativeDisconnected: "TCP Native Disconnected",
    ...
    nativeGuide: {
      ...
      connectedDesc: "TCP Native feature is available. Below are additional setup and troubleshooting methods.",
      notConnectedDesc: "Please follow the steps below to use TCP Native feature.",
      ...
      tcpNative: "TCP Native → Requires external program (Native Host) 📦",
