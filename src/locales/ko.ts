export const ko = {
  ...
  connection: {
    ...
    status: {
      ...
      tcpNativeConnected: "TCP 연결됨",
      tcpNativeConnecting: "TCP 연결 중...",
      tcpNativeFailed: "TCP 연결 실패",
      tcpNativeDisconnected: "TCP 연결 해제",
      connectedTo: "연결됨:",
      connectingTo: "연결 중:",
    ...
    nativeGuide: {
      ...
      connectedDesc: "TCP 기능을 사용할 수 있습니다. 아래는 추가 설정 및 문제해결 방법입니다.",
      notConnectedDesc: "TCP 기능을 사용하려면 아래 단계를 따라 설치해주세요.",
      ...
      tcpNative: "TCP → 외부 프로그램(Native Host) 필요 📦",
